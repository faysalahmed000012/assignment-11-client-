    ...
    <>
      <div className="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-300 sm:text-center">
          © {currentYear} Misbahul Haq All Rights Reserved.
        </span>
        <div className="flex mt-7 space-x-6 sm:justify-center md:mt-0">
          <Link
            to="https://www.facebook.com/mdmisbahul.haqfaysal"
          ...
          <Link
            to="https://github.com/faysalahmed000012"
            className="text-gray-400 hover:text-white"
          >
            <svg
              className="w-5 h-5"
